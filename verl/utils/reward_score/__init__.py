...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None, memory_limit_mb=None):
    ...
    if data_source in ["lighteval/MATH", "DigitalLearningGmbH/MATH-lighteval"]:
        ...
        "math500",
        "olympiadbench", 
        "aime_2024_dapo_boxed",
        "aime_2025_dapo_boxed",
        "amc2023_dapo_boxed",
        "minerva_math",
        "gsm8k_test",
        "omni_math_test"
    ]:
        # For multi-dataset evaluation, use specialized evaluation file
        from . import multi_datasets_eval
        # Default use both method (use DAPO and Qwen simultaneously), can specify evaluation method via extra_info parameter
    ...
    elif data_source in ["math_dapo", "deepscaler", "simplelr_qwen", "math_train"] or (data_source.startswith("aime") and data_source not in [
        "aime_2024_dapo_boxed",
        "aime_2025_dapo_boxed"
    ]):
        # For other datasets, continue using math_dapo
        # Exclude datasets that have been explicitly specified above
